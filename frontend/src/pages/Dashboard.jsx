...
export default function Dashboard() {
    ...
    const quickLinks = [
        {
            ...
            icon: CalendarIcon,
            link: trips.length > 0 ? `/calendar/${trips[0].id}` : '/calendar/demo',
            color: '#4F46E5'
        },
        {
    ...
    const sampleTrips = [
        { name: 'Weekend in Paris', country: 'France', date: 'May 2023', image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=200&h=200&fit=crop' },
        { name: 'Kyoto Temples', country: 'Japan', date: 'Apr 2023', image: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=200&h=200&fit=crop' },
        { name: 'Santorini Sun', country: 'Greece', date: 'Sep 2022', image: 'https://images.unsplash.com/photo-1613395877344-13d4a8e0d49e?w=200&h=200&fit=crop' },
    ]
        ...
        <div className="min-h-screen bg-[#FDFCF6] dark:bg-slate-900">
            ...
            <section className="px-4 py-8">
                <div className="flex justify-between items-end mb-8">
                    ...
                    {trips.length > 0 && (
                        <button className="bg-[#FF7E5F] hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-full shadow-lg transition flex items-center gap-2">
                            <Plus size={20} />
                            New Trip
                        </button>
                    )}
                            ...
                            <div className="space-y-4 flex-grow">
                                {sampleTrips.map((trip, index) => (
                                    <div key={index} className="flex gap-4 group cursor-pointer">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900 dark:text-white group-hover:text-[#FF7E5F] transition">{trip.name}</h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {trips.map((trip) => (
                            <div key={trip.id} className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                                ...
                                <div className="p-5">
                                    <h3 className="font-bold text-xl text-gray-900 dark:text-white mb-3">{trip.name}</h3>
